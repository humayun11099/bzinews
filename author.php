                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-12">
                            ...
                            $auth_id = $_GET['aid'];
                            $auth_result = mysqli_query($conn, "SELECT * FROM webmaster WHERE id = '$auth_id'");
                            if(mysqli_num_rows($auth_result)){
                                while($auth_row = mysqli_fetch_assoc($auth_result)){
                                    ?>
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold"><?php echo $auth_row['fname']; ?></h4>
                            </div>
                            <?php 
                                }
                            }
                        ...
                        WHERE post.post_author = '$auth_id' AND post.post_status = 'Active'
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            <a class="text-text-decoration-none" style="color: black;" href="author.php">
                             <div class="d-flex align-items-center">
                             <img class="rounded-circle mr-2" src="./uploads/1703800060658decfc61f98.jpg" width="25" height="25" alt="">
